...
const TABS = [
  ...
  {name: 'canli', label: 'Canli', src: LittleFinger, color: '#FF0000'},
...
const Match = [
  ...
  },
  {
    id: 5,
    name1: 'Vakıfbankspor',
    name2: 'Fenerbahçe Kadın Voleybol',
    section: 'vol',
    online: true,
    finish: false,
    fav: false,
  ...
  {
    id: 10,
    name1: 'Pınarkarşıkaya',
    name2: 'Bahçeşehir Koleji',
    section: 'bas',
    online: true,
    finish: false,
    fav: false,
